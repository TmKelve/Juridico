...
import type { LinkProcessRepository } from './link-process.types';
...
export function createPrismaLinkProcessRepository(prisma: {
  crmOpportunity: any;
  process: any;
  ...
  return {
    ...
    async linkOpportunityToProcess(update) {
      return toOpportunityRecord(await prisma.crmOpportunity.update({
