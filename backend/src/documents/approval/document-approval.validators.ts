...
import type { DocumentApprovalInput, DocumentApprovalDecision } from './document-approval.types';
...
export function normalizeDocumentApprovalInput(input: DocumentApprovalInput) {
